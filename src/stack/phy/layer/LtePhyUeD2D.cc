...
void LtePhyUeD2D::handleAirFrame(cMessage* msg)
{
    ...
    if (lteInfo->getFrameType() == HANDOVERPKT)
    {
        ...
        std::cout << "LtePhyUeD2D::handleAirFrame) flag 3 - calling handoverHandler" << endl;
...
void LtePhyUeD2D::storeAirFrame(LteAirFrame* newFrame) //this is called
{
...
void LtePhyUeD2D::sendFeedback(LteFeedbackDoubleVector fbDl, LteFeedbackDoubleVector fbUl, FeedbackRequest req)
{
    ...
    //std::cout << "LtePhyUeD2D: feedback from Feedback Generator" << endl;
