...
double timeHO_NRPhyUe = 0, eachTimeHO_NRPhyUe = 0;
...
void NRPhyUe::triggerHandover()
{
    ...
    timeHO_NRPhyUe = timeHO_NRPhyUe + handoverLatency;
//    std::cout << "NRPhyUe: Time HO: " << timeHO_NRPhyUe << endl;
    std::ofstream timeHOFile("/home/ritika/Downloads/Ritika_Project/Project_GCN_LSTM_HO/simu5G/src/Datafiles/timeHO.txt");
    timeHOFile << timeHO_NRPhyUe << endl;
    timeHOFile.close();

    eachTimeHO_NRPhyUe = handoverLatency;
//    std::cout << "NRPhyUe: Each Time HO: " << eachTimeHO_NRPhyUe << endl;
    std::ofstream eachTimeHOFile("/home/ritika/Downloads/Ritika_Project/Project_GCN_LSTM_HO/simu5G/src/Datafiles/eachTimeHO.txt");
    eachTimeHOFile << eachTimeHO_NRPhyUe << endl;
    eachTimeHOFile.close();
