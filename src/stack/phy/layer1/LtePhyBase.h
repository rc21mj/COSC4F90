...
/* Ritika
  ...
  */ //Ritika
     ...
     */
    // Ritika virtual void handleMessage(omnetpp::cMessage *msg) override;
     ...
     */
    // Ritika  virtual void sendBroadcast(LteAirFrame *airFrame);
     ...
     * Frames are sent with zero transmission delay.
     */
    // Ritika virtual void sendMulticast(LteAirFrame *frame);
     ...
     */
    // Ritika  virtual void sendUnicast(LteAirFrame *airFrame);
  ...
  // Ritika protected:
     ...
     */
    // Ritika  virtual void handleUpperMessage(omnetpp::cMessage* msg);
...
/* Ritika
    ...
    */ //Ritika
     ...
     */
    // Ritika void updateDisplayString();

    /**
     * Simple utility function to create a broadcast message for handover.
     */
    // Ritika LteAirFrame *createHandoverMessage();

    /**
     * Returns the pointer to the AMC module, given a master ID (ENODEB)
     */
    // Ritika LteAmc *getAmcModule(MacNodeId id);

    /**
     * Determine radio gate index of receiving node
     */
    // Ritika int getReceiverGateIndex(const omnetpp::cModule*, bool isNr) const;

  // Ritika public:
    /*
     * Returns the current position of the node
     */
    // Ritika const inet::Coord& getCoord() { return getRadioPosition(); }
    /*
     * Returns the time of the last transmission performed
     */
    // Ritika omnetpp::simtime_t getLastActive() { return lastActive_; }
    /*
     * Returns the MAC Node Id
     */
    // Ritika MacNodeId getMacNodeId() { return nodeId_; }
// Ritika };

// Ritika #endif  /* _LTE_AIRPHYBASE_H_ */
