...
//    }
    ...
    else if (stage == INITSTAGE_NETWORK_LAYER)
    {
        ...
        if(nodeId_>=2049)
            nodeCount = (int)nodeId_ - 2048;
        else if(nodeId_>=1025 && nodeId_<2049)
            nodeCount = (int)nodeId_ - 1024;

//        std::cout << "UE Count: " << nodeCount << endl;
        std::ofstream nodeCountFile("/home/ritika/Downloads/Ritika_Project/Project_GCN_LSTM_HO/simu5G/src/Datafiles/nodeCount.txt");
        nodeCountFile << nodeCount << endl;
        nodeCountFile.close();
        }
